# ChatGPT Business / Plus 自动开通方案

## 方案概述

通过 **API 注册 + Xvfb 虚拟显示 + Playwright CDP + Stripe 自动填表 + hCaptcha 自动点击** 实现 ChatGPT Business/Plus 套餐全自动开通。

**支持计划**:
- **Business** (团队版): `team-1-month-free`，5 席位首月 US$0.00
- **Plus** (个人版): `plus-1-month-free`，首月 US$0.00
...
+===========================================================================+
  ...
  │  │   },                                    │                        │
  │  │   "billing_details": {...},             │                        │
  │  │   "cancel_url": "...#team-pricing",     │                        │
  │  │   "promo_campaign": {                   │                        │
  │  │     "promo_campaign_id":                │  <── Business 免费试用  │
  │  │       "team-1-month-free"               │                        │
  │  │   },                                    │                        │
  ...
  │  │   },                                    │                        │
  │  │   "promo_campaign": {                   │                        │
  │  │     "promo_campaign_id":                │  <── Plus 免费试用      │
  │  │       "plus-1-month-free"               │                        │
  │  │   },                                    │                        │
  │  │   "checkout_ui_mode": "custom"          │                        │
  │  │ }                                       │                        │
  │  └─────────────────────────────────────────┘                        │
  │  注意: Plus 无 team_plan_data / cancel_url                          │
  │                                                                     │
  │  返回: checkout_session_id, publishable_key, client_secret          │
  │                                                                     │
  │  Checkout 页面定价:                                                 │
  │    Business: $150 - $150 = US$0.00 (5 x $30/席位)                   │
  │    Plus:     $20  - $20  = US$0.00                                  │
  └─────────────────────────┬───────────────────────────────────────────┘
                            │
                            v
...
| 促销 ID | 计划 | 效果 | 来源 |
|---------|------|------|------|
| `team-1-month-free` | Business | **首月 $0** (5席位) | 浏览器 "领取免费试用" ◀ Business 标签页 ✅ |
| `plus-1-month-free` | Plus | **首月 $0** (个人) | 浏览器 "领取免费试用" ◀ 个人标签页 ✅ |
| `team0dollar` | Business | ~~无效~~ (旧版，不再生效) | 旧代码/URL 参数 ❌ |
| `business_free_trial` | Business | 定价配置中显示 enabled | 未被前端使用 ❌ |
...
```json
{
  "plus":     {"month": {"amount": 20.0, "tax": "inclusive"}},
  "business": {"month": {"amount": 30.0, "tax": "exclusive"}, "year": {"amount": 25.0}},
  "go":       {"month": {"amount": 8.0,  "tax": "inclusive"}},
  "pro":      {"month": {"amount": 200.0, "tax": "inclusive"}}
}
```
...
result = bp.run_full_flow(
    ...
    plan_type="plus",  # "team" (Business) 或 "plus"
)
